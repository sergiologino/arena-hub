...
import { Flame, Zap, Target, Eye, Smartphone, Brain, BarChart3, ArrowRight, Check, Star, Sparkles, Globe, ChevronDown, Loader2, ArrowLeft } from "lucide-react"
...
export default function RoastPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      router.push(`/roast/report/${data.id}`)
    } catch (err: any) {
      ...
      <nav className="fixed top-0 w-full z-50 glass border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <Link href="/history" className="text-sm text-dark-300 hover:text-white transition">My Roasts</Link>
