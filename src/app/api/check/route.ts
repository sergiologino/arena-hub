...
import { CHECK_SYSTEM_PROMPT, buildCheckPrompt } from "@/lib/prompts/ship"
import { shipStore } from "@/lib/store"
import { CheckReport, CheckCategory } from "@/lib/types"
import { isValidUrl } from "@/lib/utils"

const PROMO_CODES: Record<string, number> = { "LAUNCH2025": 10, "SHIPIT": 5, "PRODUCTHUNT": 20, "FRIEND": 3 }
...
export async function POST(request: NextRequest) {
  try {
    ...
    await shipStore.setReport(report)
