...
import { ROAST_SYSTEM_PROMPT, ROAST_SYSTEM_PROMPT_PRO, buildUserPrompt, buildUserPromptPro } from "@/lib/prompts/roast"
import { roastStore } from "@/lib/store"
import { RoastReport, RoastCategory } from "@/lib/types"
import { isValidUrl } from "@/lib/utils"

const PROMO_CODES: Record<string, number> = { "LAUNCH2025": 10, "ROASTME": 5, "PRODUCTHUNT": 20, "FRIEND": 3 }
...
export async function POST(request: NextRequest) {
  try {
    ...
    await roastStore.setReport(report)
